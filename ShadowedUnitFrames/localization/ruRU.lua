...
L["After you hit export, you can give the below code to other Shadowed Unit Frames users and they will get your exact layout."] = "После того, как вы нажмёте \"Экспорт\", вы можете поделиться кодом, размещенным ниже, другим пользователям Shadowed Unit Frames, и они получат вашу точную расстановку вёрстки фреймов."
L["Aggro"] = "Угроза"
...
L["Background/border"] = "Фон/граница"
...
L["Blacklist filters"] = "Фильтр чёрного списка"
L["Blacklists"] = "Чёрныe списки"
L["Blizzard"] = "Blizzard"
L["Border"] = "Граница"
L["Border alpha"] = "Прозрачность границы"
L["Border color"] = "Цвет границы"
L["Border highlighting"] = "Подсвечивание границы"
...
L["Center"] = "В центре"
L["Changed profile to %s."] = "Профиль изменён на: %s."
...
L["Changes this widget into a bar, you will be able to change the height and ordering like you can change health and power bars."] = "Изменение эту верстку в полосу, вы сможете изменить высоту и порядок аналогично полосам здоровья и энергии."
...
L["Column spacing"] = "Промежуток между колонками"
...
L["Everywhere else"] = "Повсюду" -- Needs review
L["Export"] = "Экспорт"
...
L["Finished cast"] = "Завершённое применение"
L["Flight"] = "Летающая"
L["Flips coloring so the bar color is shown as the background color and the background as the bar"] = "Поменять раскраску так, чтобы цвет полосы отображался как цвет фона, а цвет фона как цвет полосы"
L["Focus"] = "Фокус"
...
L["Frame"] = "Рамка"
L["Frame alpha when you are out of combat while having no target and 100% mana or energy."] = "Прозрачность рамки вне боя, когда у вас нет цели и значение маны или энергии 100%."
...
L["Height"] = "Высота"
L["Help"] = "Справка"
L["Hide bar when empty"] = "Скрыть пустую полосу"
...
L["Highlight units that are debuffed with something you can cure."] = "Подсвечивать игрока, который поражен отрицательным эффектом который вы можете излечить/рассеять."
...
L["How large the background should tile"] = "Изменение размера мозайки фона."
L["How large the edges should be."] = "Изменение размера контура."
L["How many auras per a column for example, entering two her will create two rows that are filled up to whatever per row is set as."] = "Количество аур в колонке."
L["How many auras to show in a single row."] = "Количество аур в ряду."
L["How many groups should be shown per row."] = "Количетсво групп в ряду."
...
L["Import"] = "Импорт"
L["Import non-standard module settings"] = "Импорт нестандартных настроек модуля"
...
L["Layout manager"] = "Управление вёрсткой"
L["Leader"] = "Лидер"
L["Left"] = "Слева"
...
L["Main Assists's are set by the Blizzard Main Assist system or mods that use them such as oRA3."] = "Наводчики выбираются стандартной системой наводчиков или модификациями такими как oRA3."
L["Main Assist Target"] = "Цель наводчика"
L["Main Tank"] = "Главный танк"
L["Main Tank's are set by the Blizzard Main Tank system or mods that use them such as oRA3."] = "Главные танки установлены стандартной системой главных танков или модификациями такими как oRA3."
...
L["Max health, uses a short format, 17750 is formatted as 17.7k, values below 10000 are formatted as is."] = "Макс здоровье, используется формат сокращения, 17750 отображается как 17.7k, значения ниже 10000 не форматируются."
...
L["Override color"] = "Переопределение цвета"
L["Party"] = "Группа"
...
L["Scale"] = "Масштаб"
L["Scaled threat percent"] = "Масштабируемый % угрозы"
...
L["Sex"] = "Пол"
L["%s frames"] = "%s фреймы"
L["Short classification"] = "Краткая классификация"
L["Short classifications, R for Rare, R+ for Rare Elite, + for Elite, B for boss, nothing is shown if they aren't any of those."] = "Краткая классификация: Редкий - R, Редкий Элита - R+, Элита - +, Босс - B, если у существа нету классификации, то ничего отображаться не будет."
L["Short elite indicator"] = "Сокращённый индикатор элиты"
...
L["Show cast name"] = "Показывать название"
L["Show cast rank"] = "Показывать уровень"
L["Show cast time"] = "Показывать время"
L["Show curable only"] = "Показывать только излечимые"
L["Show party as raid"] = "Показывать группу как рейд"
...
L["Total number of combo points you have on your target."] = "Количество приёмов в серии на текущей цели."
...
L["WARNING: This will unlink all frames from each other so you can move them without another frame moving with it."] = "Предупреждение: это открепит все рамки друг от друга. Таким образом вы можете передвигать их отдельно без передвижения других рамок."
...
L["Where inside the frame the text should be anchored to."] = "В каком месте внутри рамки должен быть расположен текст."
L["Where to anchor the cast name text."] = "Место крепления текста названия применения."
L["Where to anchor the cast time text."] = "Место крепления текста времени применения."
...
L["WoW Programming is a good resource for finding out what difference API's do and how to call them."] = "WoW Programming - отличный ресурс, где можно узнать о различных функциях API."
